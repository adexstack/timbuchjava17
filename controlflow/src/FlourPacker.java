...
of 1 full bigCount bag and 4 full smallCount bags equal goal, and it's okay if there are additional
bags left over.
...
public class FlourPacker {
    public static void main(String[] args) {
        ...
        System.out.println(canPack2 (1, 0, 4));
        System.out.println(canPack2 (1, 0, 5));
        System.out.println(canPack2 (0, 5, 4));
        System.out.println(canPack2 (2, 2, 11));
        System.out.println(canPack2 (-3, 2, 12));
    ...
    public static boolean canPack2(int bigCount, int smallCount, int goal) {
        ...
        if (goal < 5) {
            return (((bigCount * 5 + smallCount) >= goal) && (smallCount >= goal));
        } else {
